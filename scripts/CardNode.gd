...
func _ready():
    ...
    cost_label.horizontal_alignment = HorizontalAlignment.RIGHT
    ...
    def_label.horizontal_alignment = HorizontalAlignment.CENTER
    ...
    effect_label.horizontal_alignment = HorizontalAlignment.CENTER
